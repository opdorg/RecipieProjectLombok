...
import org.osmand.recipie.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Recipe guacmoleRecipe = new Recipe();
        guacmoleRecipe.setDescription("Perfect Guacmole");
        guacmoleRecipe.setPrepTime(10);
        guacmoleRecipe.setCookTime(0);
        guacmoleRecipe.setDifficulty(Difficulty.EASY);
        guacmoleRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                "\n" +
        ...
        guacNotes.setRecipe(guacmoleRecipe);
        guacmoleRecipe.setNotes(guacNotes);

        guacmoleRecipe.getIngredients().add(new Ingredient("ripe avocados", new BigDecimal(2), eachUom, guacmoleRecipe));
        guacmoleRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), teaSpoonUom, guacmoleRecipe));
        guacmoleRecipe.getIngredients().add(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableSpoonUom, guacmoleRecipe));
        guacmoleRecipe.getIngredients().add(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableSpoonUom, guacmoleRecipe));
        guacmoleRecipe.getIngredients().add(new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), eachUom, guacmoleRecipe));
        guacmoleRecipe.getIngredients().add(new Ingredient("Cilantro", new BigDecimal(2), tableSpoonUom, guacmoleRecipe));
        guacmoleRecipe.getIngredients().add(new Ingredient("freshly grated black pepper", new BigDecimal(2), dashUom, guacmoleRecipe));
        guacmoleRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), eachUom, guacmoleRecipe));

        guacmoleRecipe.getCategories().add(americanCategory);
        guacmoleRecipe.getCategories().add(mexicanCategory);

        //add to return list
        recipes.add(guacmoleRecipe);
